(function(root, factory) {
    ...
    var defaults = {
        ...
        ITEM_STYLE = 'style="width:{w};height:{h};line-height:{h}"',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + '>{wk}</li>',
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}>{value}</li>',
        MONTH_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_MONTH + '>{m}月</li>',

        TEMPLATE = [
            '<!--<div class="tspic"><img src="../../image/Release/ts.png"><img src="../../image/Release/delete2.png" class="gb_btn qx"></div>-->',
            '<div class="calendar-inner">',
            '<div class="calendar-views">',
            '<div class="view view-date">',
            '<div class="calendar-hd">',
            '<div  data-calendar-display-date class="calendar-display">',
			...
			'<a href="javascript:void(0);" class="blue qx">取消</a>',
            '</div>',
            '</div>',
            ...
            '</div>',
            '</div>',
            '<div class="view view-month" style="visibility:hidden;">',
            '<div class="calendar-hd">',
            '<div data-calendar-display-month class="calendar-display">{yyyy}</div>',
            '<div class="calendar-arrow">',
            ...
            var _this = this,
                ...
                exec = {
                    prev: function() {
                    	...
                    	var d = new Date(y, m - 1);
                    	var sr = _this.selectedRang;
                    	if(sr!=null&&sr[0]!=null){
                    		if(sr[0].getTime()>=d.getTime()){
                    			$(".prev").css("color","#bbb");
                    			return false;
                    		}
                    	}
